        ...
        <div className="flex justify-between">
          {steps?.map((step, i) => (
            <>
              ...
              >
                <div
                  className={`w-12 h-12 flex items-center justify-center z-10 relative  rounded-full font-semibold text-white
                                ${
                ...
                {i !== 0 && (
                  <div
                    className={`content-['']  absolute w-full h-[3px] right-2/3 top-1/3 -translate-y-2/4 
                                ${
                                  currentStep > i
                                    ? "bg-green-600"
                                    : "bg-slate-200"
        ...
        {currentStep === 1 && (
          <div className="m-5 p-5 border rounded-md border-green-sheen">
              ...
              <div className="flex md:w-3/5">
                <div>
                  <span className="text-blue-400	">
                    {data[i].id_reporter.name}
                  </span>
                  <span> was reported </span>
                  <span className="text-blue-400	">
                    {data[i].id_reported.name}
                  </span>
                </div>
              </div>
            </div>
            <RowData
              ...
              css={"mt-5"}
            />
            <RowData titles={"Title"} data={data[i].title} css={"mt-5"} />
            <RowData titles={"Content"} data={data[i].details} css={"mt-5"} />
          </div>
        )}
        {currentStep === 2 && (
          <div className="m-5 p-5 border rounded-md border-green-sheen">
            ...
            <div className="flex justify-between my-5">
              ...
              <button className="px-2 bg-red-500 text-white font-semibold rounded-md hover:bg-white border-2 border-transparent  hover:border-2 hover:border-red-500 hover:text-red-500">
                Account Reporter
              </button>
              <button className="px-2 bg-red-500 text-white font-semibold rounded-md hover:bg-white border-2 border-transparent  hover:border-2 hover:border-red-500 hover:text-red-500">
                Account Reported
        ...
        {currentStep === 3 && !complete && (
          <div className="m-5 p-5 border rounded-md border-green-sheen">
            <div className="flex justify-between my-5">
              ...
              <button className="p-1 bg-yellow-500 text-white font-semibold rounded-md hover:bg-white border-2 border-transparent  hover:border-2 hover:border-yellow-500 hover:text-yellow-500">
                Reporter
              </button>
              <button className="p-1 bg-yellow-500 text-white font-semibold rounded-md hover:bg-white border-2 border-transparent  hover:border-2 hover:border-yellow-500 hover:text-yellow-500">
                Reported
          ...
          {!complete ? (
            <>
              <button
                ...
                onClick={() => {
                  currentStep !== 1 ? setCurrentStep(currentStep - 1) : close();
                }}
              >
