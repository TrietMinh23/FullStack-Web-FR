        ...
        <div className=" h-full px-3 py-4 overflow-y-auto bg-cultured">
          ...
          <ul className="space-y-2 font-medium">
            <li>
              <NavLink
                  to="order"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black duration-300 ease-in-out hover:text-gray-300 hover:bg-dark-jungle-green dark:hover:bg-meta-4      
                  ${
                    pathname.includes("order") &&
                    "bg-dark-jungle-green dark:bg-meta-4 text-gray-300"
                  }`}
                >
                  <svg
