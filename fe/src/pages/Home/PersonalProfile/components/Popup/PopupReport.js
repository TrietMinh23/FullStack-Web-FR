...
export default function PopupReport ({close, finish}) {
    return (
        <div className ="!w-1/3 container absolute z-10 modal p-10 h-auto ">
            <h1 className = "flex justify-center text-2xl	">Are you sure to cancel the order?</h1>
            <p className = "flex justify-center mt-4">If you cancel &gt; 3 items in a month, you will be block</p>
