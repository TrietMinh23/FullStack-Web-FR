...
export default function ChooseType() {
  ...
  return (
    <div className="flex lg:flex-row flex-col h-full">
      <div
        id="box"
        className="flex flex-col bg-[#79B695] lg:w-1/4 w-full md:h-screen h-full"
      >
        <div
          id="one"
        ...
        <div
          id="two"
          className="md:mt-20 max-md:mb-4 max-md:mt-8 px-10 text-white"
        >
          <h1 className="text-center text-2xl sm:mb-6 mb-4 font-bold leading-10">
            Technology creates an "addictive" experience
          </h1>
          <h2 className="px-5 md:text-center sm:text-justify text-start leading-8 max-md:hidden block">
            A website based on a fashion sharing platform and community launched
            in 2023.
          </h2>
        </div>
                ...
                <div className="relative flex flex-col">
                  <div className="mt-8">
                    ...
                    <Link
                      to="/login"
                      onClick={Continue}
                      className="px-14 py-4 bg-black rounded-2xl text-white"
                    >
                      Continue
                    </Link>
                  </div>
      ...
      <div className="lg:block hidden w-full">
        <div className="flex grow items-center h-full">
          <div className="w-full px-4 my-4 md:my-0 md:px-0 sm:max-w-md mx-auto lg:ml-40">
            <div>
              <h1 className="text-2xl font-bold">Choose Account Type</h1>
              <p className="text-green-sheen font-bold">
                Optimized account types for different types of users
              </p>
              <div className="relative flex flex-col">
                <div className="mt-12">
