...
export const createPaymentUrl = async (req, res, next) => {
  try {
    ...
    vnp_Params["vnp_OrderInfo"] = "Thanh toan cho ma GD:" + idOrder; // Correct the orderInfo
    ...
    res
      .cookie("orderId", idOrder + "", { maxAge: 720000 })
...
export const getVnPayReturn = async (req, res, next) => {
  ...
  if (secureHash === signed) {
    try {
      ...
      payment.paymentDetail = vnp_Params;
      await payment.save();
      return res
